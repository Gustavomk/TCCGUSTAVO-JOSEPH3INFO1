...
<body>
    ...
    $queryBusca2 = "SELECT nome_cidade from  cidade Where nome_cidade LIKE '%$busca%';";
		$resultBusca2 = mysqli_query( $link, $queryBusca2 ) or die('Falha 2, Por favor reinicie a pagina e tente novamente');
    $queryBusca3 = "SELECT nome_bairros from  bairros Where nome_bairros LIKE '%$busca%';";
		$resultBusca3 = mysqli_query( $link, $queryBusca3 ) or die('Falha 2, Por favor reinicie a pagina e tente novamente');
	$queryBusca4 = "SELECT nome_rua from ruas Where nome_rua LIKE '%$busca%';";
		$resultBusca4 = mysqli_query( $link, $queryBusca4 ) or die('Falha 2, Por favor reinicie a pagina e tente novamente');	    
	$queryBusca5 = "SELECT nome_onibus from onibus Where nome_onibus LIKE '%$busca%';";
		$resultBusca5 = mysqli_query( $link, $queryBusca5 ) or die('Falha 2, Por favor reinicie a pagina e tente novamente');	    
