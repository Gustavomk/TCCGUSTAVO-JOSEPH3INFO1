...
<head>
	...
	<meta charset="utf-8">
	<link rel="stylesheet" type="text/css" href="../Estilização/Cadastro.css">
</head>
<body>
		<?php
    $dbhost = "localhost";
...
if ($senha == $confiSenha){
  ...
  maxlength="100" placeholder="Nome Sobrenome"  required/> </p>

				<p class="t2">Nome De Usuário </br> <input type="text" name="tNome" id="input" size="90"
  maxlength="100" placeholder="NomeUsuario123"  required/> </p>

  				<p class="t2">Email </br> <input type="text" name="tEmail" id="input" size="90"
  maxlength="100" placeholder="NomeDoEmail@Email.com" pattern="[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,}$" required/> </p>
