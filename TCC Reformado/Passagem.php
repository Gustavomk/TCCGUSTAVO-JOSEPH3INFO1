...
<optgroup>
  ...
  <input type="radio" name="selectradial" id="lel">paypal</input><br/><br/>
  <input type="radio" name="selectradial" id="lel">boleto</input><br/><br/>
  <input type="radio" name="selectradial" id="lel">cartao de credito</input><br/><br/>
